...
public class KAFSampleSameAccount {

    private static final Logger log = LoggerFactory.getLogger(KAFSampleSameAccount.class);
    public static void main(String... args) {
        ...
        new KAFSampleSameAccount(streamName, region).run();
    }
    ...
    private KAFSampleSameAccount(String streamName, String region) {
    ...
    private void run() {
        ...
        ConfigsBuilder configsBuilder = new ConfigsBuilder(streamName, "sampleconxxx", kinesisClient, dynamoClient, cloudWatchClient, UUID.randomUUID().toString(), new SampleRecordProcessorFactory());
