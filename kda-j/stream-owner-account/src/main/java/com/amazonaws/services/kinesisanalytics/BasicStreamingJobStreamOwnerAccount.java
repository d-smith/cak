 ...
 */
public class BasicStreamingJobStreamOwnerAccount {
    private static final String region = "us-east-1";
    private static final String inputStreamName = "ExampleInputStream";
    private static final String outputStreamName = "ExampleOutputStream";
    private static final String roleArn = "arn:aws:iam::xxxx:role/service-role/KA-Source-Stream-Role";
    private static final String roleSessionName = "ksassumedrolesession";
    private static final String producerRoleArn = "arn:aws:iam::xxxx:role/service-role/KA-Sink-Stream-Role";
    private static final String producerRoleSessionName = "prodksassumedrolesession";
    ...
    private static FlinkKinesisProducer<String> createSinkFromStaticConfig() {
        ...
        outputProperties.setProperty(AWSConfigConstants.AWS_CREDENTIALS_PROVIDER, "ASSUME_ROLE");
        outputProperties.setProperty(AWSConfigConstants.AWS_ROLE_ARN, producerRoleArn);
        outputProperties.setProperty(AWSConfigConstants.AWS_ROLE_SESSION_NAME, producerRoleSessionName);
